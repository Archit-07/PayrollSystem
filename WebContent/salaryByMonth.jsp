...
<%
	...
	PreparedStatement pstmt=con.prepareStatement("select * from payroll_salary where emp_id=? and month=?");
...
<div class="container">
  ...
  <%
  	if(b==false)
  	{
    		...
    		%>
    		<h3><p class="text-danger">Record not found on given month</p></h3>
    		<a href="viewSalaryByEmp.jsp" class="nav-link">Back</a>
   		<%
