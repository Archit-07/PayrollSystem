...
<% 
	...
	try
	{
		...
		pstmt.executeUpdate();
		con.close();
		response.sendRedirect("update_profile.jsp?msg=Record Updated&color=text-success");
	}
	catch(Exception e)
	{
		System.out.println(e);
		response.sendRedirect("update_profile.jsp?msg=Record not Updated&color=text-danger");
	}
%>
</body>
</html>